...
// styled-components and async-component SSR stuff:
...
// manifest files
export function createReactHandler(_css = [], scripts = [], chunkManifest = {}) {
  return async function reactHandler(ctx) {
    ...
    // Bootstrap async components
    await asyncBootstrapper(components);
